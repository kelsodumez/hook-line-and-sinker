...
using System;
using TMPro;
// code courtesy of Oliver Glen Coates
...
public class BeatVisualiser : MonoBehaviour
{
    ...
    void Update()
    {
        if (playing == true)
        {
            ...
            beatText.text = Mathf.Round(beatSpawner.soundManager.songPositionInBeats).ToString();
        }
    }
}
