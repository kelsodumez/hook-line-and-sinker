...
public class RopeControllerSimple : MonoBehaviour 
{
    ...
    public void SetMaxLength(float newLength){
        maxRopeLength = newLength;
    }
    ...
    private void DisplayRope()
    {
        ...
        //Add the positions to the line renderer CHANGED TO positionCount FROM numPositions
    ...
    private void UpdateWinch()
    {
        ...
        else if (ropeLength > minRopeLength)
        {
            ropeLength -= winchSpeed * Time.deltaTime;
